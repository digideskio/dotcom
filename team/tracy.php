			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/tracy-hover.jpg">
					</div>
				</div>	
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>127<sub>countries</sub></h1>
										<p>with international students participating in my exchange program</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>11<sub>logos</sub></h1>
										<p>designed for myself &#x263a; </p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>12<sub>hours</sub></h1>
										<p>jet lag from <a href="https://www.google.com/maps/place/Qiqihar,+Heilongjiang,+China/@26.5183202,107.9602048,7z/data=!4m2!3m1!1s0x5e6612eb9f492a91:0x10c1870aa46e0446">hometown</a></p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="628958905482260484">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/QiangShih">@QiangShih</a></span>
						</div>
					</div>
				</div>
			</section>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Tracy Shi^6000", "Shi Qiang"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
