			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/jade-hover.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>12</h1>
										<p>Gabriel Garcia Marquez books read</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>10<sub>vowels</sub></h1>
										<p>in "Corporate Communications"</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="603680592874610689">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/jade_mangahis">@jade_mangahis</a></span>
						</div>
					</div>
				</div>
			</section>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Jade Mangahis^6000", "Sassafras", "B!+c# better have my money!^2000 <br>JK. N/A"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
