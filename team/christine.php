			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/christine-hover.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>1<sub></sub></h1>
										<p>times I've been on a <a href="https://www.facebook.com/FYI/videos/586043441538211/?pnref=story" target="_blank">dating reality TV show</a></p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>7<sub></sub></h1>
										<p># of nights per week I want to go <a href="https://instagram.com/p/5FyW5gDe1O/?taken-by=praytellstrategy" target="_blank">karaoke-ing</a></p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="628325531763757057">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://www.twitter.com/christinehauer">@christinehauer</a></span>
						</div>
					</div>
				</div>
			</section>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Christine Hauer^6000", "CH", "Wanna sing karaoke?"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
