...
?>   
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>4<sub></sub></h1>
										<p>number of times I've cosplayed</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>8.5<sub>hours</sub></h1>
										<p>the amount of sleep I need every night to avoid grumpiness</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>72<sub></sub></h1>
										<p>Size of my high school graduating class</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										...
										<p>I've participated in NaNoWriMo</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="628955916063408129">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/nicloutier">@nicloutier</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="nicloutier">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @nicloutier</h2><br>
							</a>
						</div>
					</div>
				</div>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Nicole Cloutier^6000", "The Goose Wrangler"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
