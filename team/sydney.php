...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/sydney-hover.jpg">
					</div>
				</div>	
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>3<sub></sub></h1>
										<p>morning raves rallied at 7am</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>13.1<sub>miles</sub></h1>
										<p>ran in Brooklyn Half Marathon with fellow Praytell-er <a href="https://instagram.com/p/2wLHoqDe5H/?taken-by=praytellstrategy" target="_blank">Hannah</a></p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>71<sub>inches</sub></h1>
										<p>tall - without my roller skates</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>7<sub></sub></h1>
										<p># of times per day I devise a snack-making strategy</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="603575325147176960">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/sydcampos415">@sydcampos415</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="squidneez">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @squidneez</h2><br>
							</a>
						</div>
					</div>
				</div>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Sydney Campos^6000", "Squidneez", "Believe in Magic"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
