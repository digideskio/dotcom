...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/justin-hover.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>V7</h1>
										<p>highest bouldering grade sent</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>10</h1>
										<p>Number of books owned that are written by Tolkien</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>24<sub>hours</sub></h1>
										<p>spent on one continuous bus ride in Argentina</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>14<sub>days</sub></h1>
										<p>Longest length of time seeing <a href="https://instagram.com/p/0I8cZyrm9X/?taken-by=graceleekang" target="_blank">Grace</a> consistently every day</p>
									</div>
								</div>
							</div>
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="jjahng">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @jjahng</h2><br>
							</a>
						</div>
					</div>
				</div>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Justin Jahng^6000", "Jtown", "Not all those who wander are lost."],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
