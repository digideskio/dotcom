...
?>   
				...
				<div class="container">
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<span class="text-white">Follow <a href="https://twitter.com/hellolittlefish">@hellolittlefish</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="hellolittlefish">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @hellolittlefish</h2><br>
							</a>
						</div>
					</div>
				</div>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Olivia Gulin^6000", "OG", "Olive"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
