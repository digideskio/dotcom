...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/erika-hover.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>15<sub>times</sub></h1>
										<p>I laugh at my own jokes daily</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>20<sub></sub></h1>
										<p>most meetings booked for a single client at CES</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										...
										<p>I spent in a school uniform</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>20<sub></sub></h1>
										<p>number of times I say y'all in one day</p>
									</div>
								</div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<span class="text-white">Follow <a href=""></a></span>
						</div>
					</div>
				</div>
			</section>-->
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="ejanis">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @ejanis</h2><br>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Erika Janis^6000", "EJ", "Eeej", "Janis"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
