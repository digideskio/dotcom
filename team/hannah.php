...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/hannah-hover.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>2<sub></sub></h1>
										<p>full marathons under my belt (Sydney + New York)</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>30<sub>hours</sub></h1>
										<p>it takes me (door to door) when I go home to visit Sydney</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="628331265201147905">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/hannahgandevia">@hannahgandevia</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<!--<section class="instagram-1">
				<div class="instafeed" data-user-name="hannahdel">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @hannahdel</h2><br>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Hannah Gandevia^6000", "Hannadel"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
