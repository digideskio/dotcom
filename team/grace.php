...
?>   
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="graceleekang">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @graceleekang</h2><br>
								<span class="text-white">Bloopy Times!</span>
							</a>
						</div>
					</div>
				</div>
