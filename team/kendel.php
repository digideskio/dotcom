                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>3<sub></sub></h1>
										<p>Tweets of hers that Vince Staples has Liked</p>
                                        <p>&nbsp;</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>200+<sub></sub></h1>
										<p>views of "You've Got Mail" in her lifetime</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>10<sub></sub></h1>
										<p>times per day she'll talk about Detroit and how great it is yeah yeah Kendel we get it</p>
									</div>
								</div>
							</div>
