...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/kiri.jpg">
					</div>
				</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>8<sub></sub></h1>
										<p>comic cons gone to in the past 5 years</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>21<sub></sub></h1>
										<p>different varieties of tea I have (and counting)</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>3<sub>times</sub></h1>
										<p>I go to the gym during the week</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>459,793<sub></sub></h1>
										<p>number of views my YouTube parody video has</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="669217231839109121">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/DependableVA"></a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="instagram-1">
				<div class="instafeed" data-user-name="krlrix">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @krlrix</h2><br>
...
<script>
        $(function(){
            ...
            $("#typed").typed({
                strings: ["Kiri Mohan^6000", "Jedi", "Wobbles"],
                typeSpeed: 10,
                backDelay: 2000,
            	backSpeed: -30,
                loop: true,
