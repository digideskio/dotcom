...
?>   
			...
			<section class="image-block short-pad team-member">
				...
				<div class="image-holder col-md-4 col-sm-4 pull-left">
					<div class="background-image-holder">
						<img alt="<?php echo $title ?> // Praytell" title="<?php echo $title ?> // Praytell" class="background-image" src="/img/team/leah-hover.jpg">
					</div>
				</div>	
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>32<sub></sub></h1>
										<p>professional voice over commercials to date</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>1<sub>spouse</sub></h1>
										<p>and 1 Child (Joey and Gianna respectively)</p>
                                        <p>&nbsp;</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>8<sub></sub></h1>
										<p>the number of parking tickets I have gotten in Brooklyn</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="narrow-feature">
									...
									<div class="content">
										<h1>6<sub></sub></h1>
										<p>the number of collective nieces and nephews I have</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-7 col-sm-9">
							...
							<div class="twitter-feed">
								<div class="tweets-feed tweets-slider" data-widget-id="628940934718312448">
								</div>
							</div>
							<span class="text-white">Follow <a href="https://twitter.com/leahglupo">@leahglupo</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<!--<section class="instagram-1">
				<div class="instafeed" data-user-name="leahglupo">
					<ul></ul>
				</div>
				...
				<div class="container vertical-align">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#">
								<h2 class="text-white"><i class="icon social_instagram"></i> @leahglupo</h2><br>
							</a>
						</div>
					</div>
				</div>
