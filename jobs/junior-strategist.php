				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-12">
                                ...
                                <p class="super-lead">Praytell is looking for a junior strategist to join our creative communications agency. We're 40+ strong in Brooklyn and beyond, with PRWeek Agency of the Year, Holmes Best New Agency and PRWeek Best Places to Work awards under our belt.</p>
                                
                                <p class="lead">We've got killer client partners, a pipeline that is ridiculous, culture you can’t beat and serious momentum. Seriously, if you’ve got that strategy brain, this is the gig you’ve been waiting for, assuming you’re awesome, get social and want to change the world.</p>

								<p class="lead">To support our rapidly growing team, we’re looking to hire a junior strategist with consumer brand experience. If you have 1-3 years of business strategy working at an agency or in-house, love digital, creative communications, big ideas, the full gamut (see below), we’d love to hear from you. If it sounds like a fit, send us an email that tells us why you're the right person to join us on this incredible journey (GIFs = bonus points). And like any good pitch, the subject line matters, big time.</p>
...
<h3 class="color-accent">Responsibilities</h3>
                                ...
                                <ul class="bullets">
                                	...
                                	<li>Client relations and communications</li>
                                	<li>Awesome research skills producing smart thinking recommendations</li>
                                	<li>Influencer relations experience</li>
                                	<li>Writing and editing (key messaging, custom pitches, strategic POVs, etc.)</li>
                                	<li>Reading the news and staying current (-;</li>
                                	<li>Collaboration with PR, content and creative teams on integrated campaigns</li>
                                ...
                                <ul class="bullets">
                                	<li>1-3 of experience at a digital or social agency or in-house with consumer brands</li>
                                	...
                                	<li>Proven experience garnering results with clients and influencers</li>
                                	<li>Excellent writing and presentation skills</li>
                                	<li>Strong organization skills to manage multiple projects, media pitches, client requests, etc.</li>
				...
				<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
								...
								<a class="btn btn-white btn-filled" href="mailto:jobs@praytellagency.com?subject=Junior Strategist"><i class="icon icon_mail"></i>&nbsp; Apply Now</a>
							</div>
						</div>
				</div>
			</section>
